...
HD_PWD='C:/Users/hr08032/Desktop/Final Project Final Folder FINAL/AIK DAM FINAL/pinScreen/pinScreen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topLevelProject.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topLevelProject.tcl -notrace
