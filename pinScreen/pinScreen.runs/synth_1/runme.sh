...
HD_PWD='C:/Users/hr08032/Desktop/Final Project Final Folder FINAL/AIK DAM FINAL/pinScreen/pinScreen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topLevelProject.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topLevelProject.tcl
